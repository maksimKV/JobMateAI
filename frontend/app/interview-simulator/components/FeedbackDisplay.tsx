        ...
        <div className="space-y-4">
          <div className="flex flex-col items-center text-center mb-4">
            <div className="flex items-center">
              ...
              <h4 className="text-lg font-medium text-gray-900">Question & Feedback</h4>
            </div>
          </div>
          
          <div className="space-y-4">
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <h5 className="text-sm font-medium text-gray-900 mb-1">Question</h5>
              <p className="text-gray-700">{displayQuestion}</p>
              
              <h5 className="text-sm font-medium text-gray-900 mt-3 mb-1">Your Answer</h5>
              <p className="text-gray-700 whitespace-pre-line">{displayAnswer}</p>
              
              <h5 className="text-sm font-medium text-gray-900 mt-3 mb-1">Feedback</h5>
